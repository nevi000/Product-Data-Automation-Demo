...
The production system also pushes the generated images to a shared cloud drive
so the studio team can retouch them. That is one method behind a narrow
interface; here it writes to a local folder.
"""
